...
export default function OrganizationDetails() {
  ...
  return (
    <div className="flex p-10 gap-5">
      <div className="w-full mx-auto p-8 bg-[rgb(229,231,235)]/10 text-white rounded-lg shadow-xl ">
        <Card>
          ...
          <CardTitle>{request.orgType}</CardTitle>
          <CardDescription>
...
const Skeleton = () => {
  ...
  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2"></div>
...
export const Card = ({ className, children }) => {
  return (
    <div
      className={cn(
        "max-w-xl w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
