    ...
    try {
      ...
      let solvalue = await convertInrToSol(requestedAmount)
        ...
        if (response.status === 200) {
          alert("Small fund request processed automatically!");
        } else {
          alert("Form submitted but automatic processing failed");
        }
      } else {
        // For larger requests, just submit the form without calling automation
        alert("Form submitted successfully. Request will be reviewed.");
      }
